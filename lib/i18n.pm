...
One thing we plan to do next is to provide collaborative, just-in-time lexicon
creation tools.  So Joe American could write his wonderful Perl script in
English, with the appropriate C<~~> notation, and 24 hours later it would "just
work" in Swahili.
